...
//                     <div>
//                         <img width={"45px"} src="src/assets/share.svg" alt="cart" />
//                         <p>Send list to others</p>
//                         <img width={"45px"} src="src/assets/more.svg" alt="cart" />
//                     </div>

//                 </div>

//                 <div>
//                     <img width={"45px"} src="src/assets/grid.svg" alt="cart" />
//                     <img width={"45px"} src="src/assets/list.svg" alt="cart" />
//                     <input type="text" placeholder="Search this list" />
//                     <input type="checkbox" placeholder="Filter  & Sort" />
//                 </div>
...
// function ShoppingItemComponent({ imageUrl, title, price }) {
//     return (
//         <>
//             <div>
