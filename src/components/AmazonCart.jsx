          ...
          <div style={cartStyles.box}>
            ...
            <div style={itemStyles.container}>
              ...
              <div style={itemStyles.details}>
                <h2 style={itemStyles.title}>{item1.title}</h2>
              ...
              <p style={itemStyles.price}>₹{item1.price.toFixed(2)}</p>
            </div>

            {/* Item 2 (from image, to match summary) */}
            <div style={{ ...itemStyles.container, ...itemStyles.lastItem }}>
              <div style={itemStyles.imageBox}>
                <img
                  src={item2.imageUrl}
                  alt={item2.title}
              ...
              <div style={itemStyles.details}>
                <h2 style={itemStyles.title}>{item2.title}</h2>
                <p style={itemStyles.stock}>In stock</p>
                <div style={itemStyles.controls}>
                  <div style={itemStyles.quantityBox}>
                    <button style={itemStyles.quantityButton}>-</button>
              ...
              <p style={itemStyles.price}>₹{item2.price.toFixed(2)}</p>
            </div>
          </div>
        </div>
